...
pub struct DlnOrderEstimation {
    ...
    #[serde(rename = "recommendedSlippage", skip_serializing_if = "Option::is_none")]
...
impl DlnOrderEstimation {
    pub fn new(src_chain_token_in: models::SrcChainTokenInResponseType, dst_chain_token_out: models::DstChainTokenOutResponseType, costs_details: Vec<models::CostsDetailsProperty>) -> DlnOrderEstimation {
        DlnOrderEstimation {
