...
impl SrcChainTokenOutResponseType {
    pub fn new(address: String, name: String, symbol: String, decimals: i32, amount: String, chain_id: f64, max_refund_amount: String, approximate_usd_value: f64) -> SrcChainTokenOutResponseType {
