...
pub struct ChainTransactionResponseV10 {
    ...
    #[serde(rename = "tx")]
    pub tx: Box<models::Tx>,
}

impl ChainTransactionResponseV10 {
    pub fn new(token_in: models::TokenWithAmount, token_out: models::TokenWithMinAmount, slippage: f64, recommended_slippage: f64, tx: models::Tx) -> ChainTransactionResponseV10 {
