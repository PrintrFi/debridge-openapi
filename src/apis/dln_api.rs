...
pub async fn dln_order_controller_v10_cancel_order(
    configuration: &configuration::Configuration,
    id: &str,
) -> Result<models::DlnOrderCancelTxResponse, Error<DlnOrderControllerV10CancelOrderError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<DlnOrderControllerV10CancelOrderError> =
...
pub fn dln_order_controller_v10_create_order_request(
    ...
    dst_chain_token_out_amount: Option<&str>,
    additional_taker_reward_bps: Option<i32>,
    src_intermediary_token_address: Option<&str>,
    dst_intermediary_token_address: Option<&str>,
    dst_intermediary_token_spender_address: Option<&str>,
    intermediary_token_usd_price: Option<f64>,
    dst_chain_token_out_recipient: Option<&str>,
    sender_address: Option<&str>,
    src_chain_order_authority_address: Option<&str>,
    src_allowed_cancel_beneficiary: Option<&str>,
    referral_code: Option<&str>,
    affiliate_fee_percent: Option<f64>,
    affiliate_fee_recipient: Option<&str>,
    src_chain_token_in_sender_permit: Option<&str>,
    dst_chain_order_authority_address: Option<&str>,
    enable_estimate: Option<bool>,
    allowed_taker: Option<&str>,
    external_call: Option<&str>,
    dln_hook: Option<&str>,
    prepend_operating_expenses: Option<bool>,
    metadata: Option<&str>,
    otc: Option<bool>,
    ptp: Option<bool>,
    ...
    req_builder = req_builder.query(&[(
        ...
        &p_src_chain_token_in_amount.to_string(),
    )]);
    ...
    if let Some(ref param_value) = p_src_intermediary_token_address {
        req_builder =
            req_builder.query(&[("srcIntermediaryTokenAddress", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_dst_intermediary_token_address {
        req_builder =
            req_builder.query(&[("dstIntermediaryTokenAddress", &param_value.to_string())]);
    }
    ...
    if let Some(ref param_value) = p_src_chain_order_authority_address {
        req_builder =
            req_builder.query(&[("srcChainOrderAuthorityAddress", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_src_allowed_cancel_beneficiary {
        req_builder =
            req_builder.query(&[("srcAllowedCancelBeneficiary", &param_value.to_string())]);
    }
    ...
    if let Some(ref param_value) = p_src_chain_token_in_sender_permit {
        req_builder =
            req_builder.query(&[("srcChainTokenInSenderPermit", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_dst_chain_order_authority_address {
        req_builder =
            req_builder.query(&[("dstChainOrderAuthorityAddress", &param_value.to_string())]);
    }
    ...
    if let Some(ref param_value) = p_skip_solana_recipient_validation {
        req_builder =
            req_builder.query(&[("skipSolanaRecipientValidation", &param_value.to_string())]);
    }
...
> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<DlnOrderControllerV10CreateOrderError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn dln_order_controller_v10_ext_call_cancel_order(
    configuration: &configuration::Configuration,
    id: &str,
) -> Result<models::DlnOrderCancelTxResponse, Error<DlnOrderControllerV10ExtCallCancelOrderError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<DlnOrderControllerV10ExtCallCancelOrderError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn dln_order_controller_v10_get_order(
    configuration: &configuration::Configuration,
    id: &str,
) -> Result<models::DlnOrderResponse, Error<DlnOrderControllerV10GetOrderError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<DlnOrderControllerV10GetOrderError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn dln_order_controller_v10_get_order_ids_by_tx(
    configuration: &configuration::Configuration,
    hash: &str,
) -> Result<models::DlnOrderidsByTxResponse, Error<DlnOrderControllerV10GetOrderIdsByTxError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_hash = hash;
    ...
    let uri_str = format!(
        ...
        configuration.base_path,
        hash = crate::apis::urlencode(p_hash)
    );
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<DlnOrderControllerV10GetOrderIdsByTxError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
/// This endpoint returns the status of order.
pub async fn dln_order_controller_v10_get_order_status(
    configuration: &configuration::Configuration,
    id: &str,
) -> Result<models::DlnOrderStatusResponse, Error<DlnOrderControllerV10GetOrderStatusError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<DlnOrderControllerV10GetOrderStatusError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
